...
// Description:
//
// CommTest2.nc is the device's main Neuron C source file, which
// automatically includes other application-specific Neuron C source or header
// files as necessary. The CommTest2.nc file also contains the
// system tasks (when(reset), etc), network variables and the file directory.
//
//////////////////////////////////////////////////////////////////////////////

#ifndef _CommTest2_NC_
#define _CommTest2_NC_

#define _CODEWIZARD_VERSION_3_TEMPLATES_
// There is no real science behind these numbers.  These values should exceed needs
...
// system_image_extensions pragma, see CommTest2.h.
